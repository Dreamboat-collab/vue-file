        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="booking-tag">
              <ul>
                <li><router-link to="/bklist"><i class="flaticon-flight"></i>Flight Booking</router-link></li>
                <li><router-link to="/bklist"><i class="flaticon-home"></i>Hotel Booking</router-link></li>
                <li><router-link to="/attraction"><i class="flaticon-eiffel-tower"></i>Attractions</router-link></li>
                <li><router-link to="/bklist"><i class="flaticon-clock"></i>Flight Status</router-link></li>
              </ul>
            </div>
          </div>
        </div>
