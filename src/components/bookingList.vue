                            ...
                            <li>
                              <div class="form-grp economy" style="border-left:rgba(144,144,144,0.29) 1px solid;">
                                ...
                                >
                                  ...
                                  <template #reference>
                                    <label for="text" style="text-decoration: underline">Redeem points</label>
                                  </template>
                                </el-popover>
              ...
              <div class="booking-list-item-inner">
                <div class="booking-list-top">
                  ...
                  <div class="flight-price">
                    ...
                    <router-link
                        :to="{name:'bkdtls',query: { depart:item['depart'],name: item['name'],arrival:item['arrival'],price:item['price'],departTime:item['depart_date'],arrivalTime: item['arrival_date'],grade:item['grade'],flightId:item['id']}}"
                        class="btn">Select <i class="flaticon-flight-1"></i></router-link>
                  </div>
                </div>
              ...
              <div class="booking-list-item-inner">
                <div class="booking-list-top">
                  ...
                  <div class="flight-price">
                    <h4 class="title">US$ {{ item['price'] }}.00</h4>
                    <router-link
                        :to="{name:'bkdtls',query: { name:item['name'],hotelId: item['id'],days:days,price:item['price']}}"
                        class="btn">Select <i class="flaticon-flight-1"></i></router-link>
                  </div>
                </div>
                <div class="booking-list-bottom">
