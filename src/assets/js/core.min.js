 ...
 * @license      MIT License
 */
// (function(l,F,r,m,G){function u(a){a=a.split(")");var b=l.trim,f=-1,e=a.length-1,d,h,g=v?new Float32Array(6):[],c=v?new Float32Array(6):[],k=v?new Float32Array(6):[1,0,0,1,0,0];g[0]=g[3]=k[0]=k[3]=1;for(g[1]=g[2]=g[4]=g[5]=0;++f<e;){d=a[f].split("(");h=b(d[0]);d=d[1];c[0]=c[3]=1;c[1]=c[2]=c[4]=c[5]=0;switch(h){case "translateX":c[4]=parseInt(d,10);break;case "translateY":c[5]=parseInt(d,10);break;case "translate":d=d.split(",");c[4]=parseInt(d[0],10);c[5]=parseInt(d[1]||0,10);break;case "rotate":d=
// 	t(d);c[0]=m.cos(d);c[1]=m.sin(d);c[2]=-m.sin(d);c[3]=m.cos(d);break;case "scaleX":c[0]=+d;break;case "scaleY":c[3]=d;break;case "scale":d=d.split(",");c[0]=d[0];c[3]=1<d.length?d[1]:d[0];break;case "skewX":c[2]=m.tan(t(d));break;case "skewY":c[1]=m.tan(t(d));break;case "matrix":d=d.split(","),c[0]=d[0],c[1]=d[1],c[2]=d[2],c[3]=d[3],c[4]=parseInt(d[4],10),c[5]=parseInt(d[5],10)}k[0]=g[0]*c[0]+g[2]*c[1];k[1]=g[1]*c[0]+g[3]*c[1];k[2]=g[0]*c[2]+g[2]*c[3];k[3]=g[1]*c[2]+g[3]*c[3];k[4]=g[0]*c[4]+g[2]*c[5]+
// 	g[4];k[5]=g[1]*c[4]+g[3]*c[5]+g[5];g=[k[0],k[1],k[2],k[3],k[4],k[5]]}return k}function w(a){var b,f,e,d=a[0],h=a[1],g=a[2],c=a[3];d*c-h*g?(b=m.sqrt(d*d+h*h),d/=b,h/=b,e=d*g+h*c,g-=d*e,c-=h*e,f=m.sqrt(g*g+c*c),e/=f,c/f*d<g/f*h&&(d=-d,h=-h,e=-e,b=-b)):b=f=e=0;return[["translate",[+a[4],+a[5]]],["rotate",m.atan2(h,d)],["skewX",m.atan(e)],["scale",[b,f]]]}function H(a,b){var f={start:[],end:[]},e=-1,d,h,g,c;("none"==a||C.test(a))&&(a="");("none"==b||C.test(b))&&(b="");a&&b&&!b.indexOf("matrix")&&x(a).join()==
// x(b.split(")")[0]).join()&&(f.origin=a,a="",b=b.slice(b.indexOf(")")+1));if(a||b){if(a&&b&&a.replace(/(?:\([^)]*\))|\s/g,"")!=b.replace(/(?:\([^)]*\))|\s/g,""))f.start=w(u(a)),f.end=w(u(b));else for(a&&(a=a.split(")"))&&(d=a.length),b&&(b=b.split(")"))&&(d=b.length);++e<d-1;){a[e]&&(h=a[e].split("("));b[e]&&(g=b[e].split("("));c=l.trim((h||g)[0]);for(var k=f.start,m=D(c,h?h[1]:0),n;n=m.shift();)k.push(n);k=f.end;for(c=D(c,g?g[1]:0);m=c.shift();)k.push(m)}return f}}function D(a,b){var f=+!a.indexOf("scale"),
// 	e,d=a.replace(/e[XY]/,"e");switch(a){case "translateY":case "scaleY":b=[f,b?parseFloat(b):f];break;case "translateX":case "translate":case "scaleX":e=1;case "scale":b=b?(b=b.split(","))&&[parseFloat(b[0]),parseFloat(1<b.length?b[1]:"scale"==a?e||b[0]:f+"")]:[f,f];break;case "skewX":case "skewY":case "rotate":b=b?t(b):0;break;case "matrix":return w(b?x(b):[1,0,0,1,0,0])}return[[d,b]]}function t(a){return~a.indexOf("deg")?parseInt(a,10)*(2*m.PI/360):~a.indexOf("grad")?parseInt(a,10)*(m.PI/200):parseFloat(a)}
...
// 		h,1):b.style[n]=h};l.transform={centerOrigin:"margin"}})(jQuery,window,document,Math);
...
// 	!0});b.data=d;f.call(a,b)};document.addEventListener?a.addEventListener(c,e,!1):a.attachEvent("on"+c,e);b._binds.push({elem:a,type:c,func:f,fnc:e})}function n(a){a.data.position.x=a.pageX;a.data.position.y=a.pageY;a.data.start.x=a.pageX;a.data.start.y=a.pageY;a.data.event=a;a.data.onstart&&a.data.onstart.call(a.data.element,a.data)||(a.preventDefault&&a.data.preventDefault&&a.preventDefault(),a.stopPropagation&&a.data.stopPropagation&&a.stopPropagation(),b(a.data.affects,"mousemove",h,a.data),b(a.data.affects,
// 	"mouseup",k,a.data))}function h(a){a.preventDefault&&a.data.preventDefault&&a.preventDefault();a.stopPropagation&&a.data.preventDefault&&a.stopPropagation();a.data.move.x=a.pageX-a.data.position.x;a.data.move.y=a.pageY-a.data.position.y;a.data.position.x=a.pageX;a.data.position.y=a.pageY;a.data.offset.x=a.pageX-a.data.start.x;a.data.offset.y=a.pageY-a.data.start.y;a.data.event=a;a.data.onmove&&a.data.onmove.call(a.data.element,a.data)}function k(a){a.preventDefault&&a.data.preventDefault&&a.preventDefault();
...
// 	y:0},start:{x:0,y:0},affects:document.documentElement,stopPropagation:!1,preventDefault:!0,touch:!0};q(c,a);c.element=this;b(this,"mousedown",n,c);c.touch&&b(this,"touchstart",p,c)})};g.fn.ungrab=function(a){return this.each(function(){e(this,"mousedown","mousedown")})}})(jQuery);
...
var CirclePlayer=function(a,b,c){var d=this;this.cssClass={gt50:"cp-gt50",fallback:"cp-fallback"};this.spritePitch=104;this.spriteRatio=.24;this.player=$(a);this.media=$.extend({},b);this.options=$.extend(!0,{},{supplied:"m4a, oga",cssSelectorAncestor:"#cp_container_1",cssSelector:{play:".cp-play",pause:".cp-pause"}},c);this.cssTransforms=Modernizr.csstransforms;this.audio={};this.dragging=!1;this.eventNamespace=".CirclePlayer";this.jq={};$.each({bufferHolder:".cp-buffer-holder",buffer1:".cp-buffer-1",
	buffer2:".cp-buffer-2",progressHolder:".cp-progress-holder",progress1:".cp-progress-1",progress2:".cp-progress-2",circleControl:".cp-circle-control"},function(a,b){d.jq[a]=$(d.options.cssSelectorAncestor+" "+b)});this._initSolution();this._initPlayer()};
CirclePlayer.prototype={_createHtml:function(){},_initPlayer:function(){var a=this;this.player.jPlayer(this.options);this.player.bind($.jPlayer.event.ready+this.eventNamespace,function(b){b.jPlayer.html.used&&b.jPlayer.html.audio.available&&(a.audio=$(this).data("jPlayer").htmlElement.audio);$(this).jPlayer("setMedia",a.media);a._initCircleControl()});this.player.bind($.jPlayer.event.play+this.eventNamespace,function(a){$(this).jPlayer("pauseOthers")});this.player.bind($.jPlayer.event.timeupdate+
	...
	_initSolution:function(){this.cssTransforms?(this.jq.progressHolder.show(),this.jq.bufferHolder.show()):(this.jq.progressHolder.addClass(this.cssClass.gt50).show(),this.jq.progress1.addClass(this.cssClass.fallback),this.jq.progress2.hide(),this.jq.bufferHolder.hide());this._resetSolution()},_resetSolution:function(){this.cssTransforms?(this.jq.progressHolder.removeClass(this.cssClass.gt50),this.jq.progress1.css({transform:"rotate(0deg)"}),this.jq.progress2.css({transform:"rotate(0deg)"}).hide()):
		this.jq.progress1.css("background-position","0 "+this.spritePitch+"px")},_initCircleControl:function(){var a=this;this.jq.circleControl.grab({onstart:function(){a.dragging=!0},onmove:function(b){b=a._getArcPercent(b.position.x,b.position.y);a.player.jPlayer("playHead",b).jPlayer("play");a._timeupdate(b)},onfinish:function(b){a.dragging=!1;b=a._getArcPercent(b.position.x,b.position.y);a.player.jPlayer("playHead",b).jPlayer("play")}})},_timeupdate:function(a){var b=3.6*a+"deg",c=(Math.floor(Math.round(a)*
